...
- 🖼 **Photo posts too** — Instagram carousels and TikTok photo-mode posts arrive as compact Telegram photo albums (10 per album), with the post caption attached. Needs [gallery-dl](https://github.com/mikf/gallery-dl) on the host (`pip3 install --break-system-packages gallery-dl`); the Dockerfile installs it for you.
